...
export function baselineOwnership(): OwnershipEntry[] {
  return [
    ...
    { system: 'placements', owner: 'universal', legacyRole: 'compatibility', note: 'Stage 16 create/move/remove, both Greyholm and user-campaign (create id via shared mintPlacementId() authority)' },
    { system: 'reveal', owner: 'universal', legacyRole: 'compatibility', note: 'Stage 16, both Greyholm and user-campaign (UC reveal cascades to linked placements + image atomically)' },
    { system: 'presented-cards', owner: 'universal', legacyRole: 'compatibility', note: 'Stage 16, both Greyholm and user-campaign (UC clears any presented battle atomically, one-directionally)' },
    { system: 'party', owner: 'universal', legacyRole: 'compatibility', note: 'Stage 16 partyLocation.move — arrival + direct-move + atomic route-progress clear, Greyholm only (UC has no party runtime)' },
    { system: 'routes', owner: 'universal', legacyRole: 'compatibility', note: 'Stage 16 routeProgress.advance/clear — atomic map-position clear on advance, Greyholm only' },
