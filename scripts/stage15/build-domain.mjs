// Compiles the universal domain (incl. src/domain/durable-authority/**) to
// standalone ESM under scripts/stage15/.dist so the Stage 15 harness runs from
// plain Node.
...
console.log('Stage 15 domain build complete.');
