// Compiles the universal domain to standalone ESM under scripts/stage11/.dist so
// the Stage 11 harness runs from plain Node (same approach as Stage 9/10).
...
console.log('Stage 11 domain build complete.');
